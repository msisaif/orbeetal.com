...
export function Hero() {
  const badgeMotion = useSafeMotion({
  ...
  return (
    <section className="relative flex items-center hero-top-spacing pb-8 overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-30">
        <div className="max-w-4xl mx-auto text-center py-8 lg:py-0">
          ...
          <m.h1
            {...titleMotion}
            className="text-hero-display font-display font-bold tracking-tight mb-8"
          >
          ...
          <m.p
            {...descMotion}
            className="text-lg md:text-2xl text-body-muted max-w-2xl mx-auto mb-12 font-light leading-relaxed"
          >
          ...
          >
            <Button
              size="lg"
              className="w-full sm:w-auto h-14 px-8 text-lg bg-primary hover:bg-primary/90 text-white border-none shadow-[0_0_40px_-10px_rgba(0,112,243,0.5)]"
