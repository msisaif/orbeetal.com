...
export function PortfolioGrid({ portfolioProjects }) {
            ...
            >
              <div className={`h-60 bg-linear-to-br ${project.color} relative overflow-hidden`}>
                ...
                <div className="absolute top-4 left-4">
                  <span className="text-xs text-body-muted bg-black/40 border border-white/10 px-3 py-1 rounded-full backdrop-blur-sm">
                    {project.category}
                  </span>
                </div>
                {project.link && (
