...
const linkClassName =
  "group flex items-center gap-5 p-4 rounded-xl border border-white/5 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring";
      ...
      <MotionFadeIn x={-20} y={0}>
        <GlassCard className="rounded-2xl border border-white/10 p-8 md:p-10 flex flex-col gap-6 h-full">
          ...
          <a
            ...
            className={`${linkClassName} hover:border-primary/30 hover:bg-primary/5`}
          >
            ...
            <div>
              <div className="text-xs text-body-muted uppercase tracking-wider mb-1">Email</div>
          ...
          <a
            ...
            className={`${linkClassName} hover:border-green-500/30 hover:bg-green-500/5`}
          >
            ...
            <div>
              <div className="text-xs text-body-muted uppercase tracking-wider mb-1">WhatsApp</div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`${linkClassName} hover:border-blue-500/30 hover:bg-blue-500/5`}
          >
            ...
            <div>
              <div className="text-xs text-body-muted uppercase tracking-wider mb-1">Facebook</div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`${linkClassName} hover:border-sky-500/30 hover:bg-sky-500/5`}
          >
            ...
            <div>
              <div className="text-xs text-body-muted uppercase tracking-wider mb-1">LinkedIn</div>
