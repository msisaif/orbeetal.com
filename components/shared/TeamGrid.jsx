      ...
      {teamMembers.map((member, i) => {
        ...
        return (
          <MotionFadeIn
            ...
            y={24}
            delay={i * 0.08}
            className={isLast && teamMembers.length % 4 !== 0 ? "sm:col-span-2 lg:col-span-1" : undefined}
          >
            <GlassCard className="group rounded-2xl p-7 border border-white/5 hover:border-primary/25 transition-all duration-500 text-center h-full">
              <div className="relative mx-auto mb-5 w-20 h-20">
                <div
                  className={`w-20 h-20 rounded-full bg-linear-to-br ${member.gradient} flex items-center justify-center text-white text-2xl font-display font-bold shadow-lg`}
                >
                  {member.initials}
                </div>
